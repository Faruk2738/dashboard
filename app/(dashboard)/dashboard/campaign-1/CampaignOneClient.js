...
const campaigns = [
  {
    ...
    image: '/campaigns/ride-again-at-risk.jpeg', position: '70% 42%', accent: '#84cc16', audience: 3238, Icon: RefreshCw,
  },
  {
    ...
    image: '/campaigns/loyalty-loyal.jpeg', position: '22% 45%', accent: '#f59e0b', audience: 3259, Icon: Medal,
  },
  {
    ...
    image: '/campaigns/special-cant-lose.jpeg', position: '58% 45%', accent: '#a3e635', audience: 1039, Icon: Sparkles,
  },
  {
    ...
    image: '/campaigns/ambassador-champions.jpeg', position: '70% 38%', accent: '#22c55e', audience: 1742, Icon: UsersRound,
  },
  {
    ...
    image: '/campaigns/welcome-new.jpeg', position: '50% 38%', accent: '#38bdf8', audience: 3286, audienceNote: '772 New + 2,514 Potential Loyalists', Icon: Gift,
  },
  {
    ...
    image: '/campaigns/last-chance-hibernating.jpeg', position: '66% 40%', accent: '#facc15', audience: 3115, Icon: TimerReset,
  },
];
    ...
    <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4 lg:auto-rows-[210px]">
      {displayCampaigns.map((campaign) => {
        ...
        return <article key={segment} onClick={() => toggle('rfmSegment', filter)} className={`group relative min-h-[250px] cursor-pointer overflow-hidden rounded-2xl border text-left text-white shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl lg:min-h-0 ${cardLayout[segment]} ${selected ? 'ring-2 ring-blue-400 ring-offset-2' : 'border-slate-300'}`}>
          <Image src={image} alt={`${title} campaign for ${segment}`} fill sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" className="object-cover transition duration-500 group-hover:scale-105" style={{ objectPosition: position }} />
